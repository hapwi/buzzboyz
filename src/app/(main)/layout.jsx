...
import posterImage from '@/images/poster1.png'
...
function InstagramIcon(props) {
  return (
    <svg aria-hidden="true" viewBox="0 0 32 32" {...props}>
      <path d="M16 3.038c-3.523 0-3.965.015-5.35.078-1.382.063-2.326.283-3.152.604a6.363 6.363 0 0 0-2.3 1.498 6.363 6.363 0 0 0-1.498 2.3c-.321.826-.541 1.77-.604 3.152-.063 1.385-.078 1.827-.078 5.35s.015 3.965.078 5.35c.063 1.382.283 2.326.604 3.152a6.363 6.363 0 0 0 1.498 2.3 6.363 6.363 0 0 0 2.3 1.498c.826.321 1.77.541 3.152.604 1.385.063 1.827.078 5.35.078s3.965-.015 5.35-.078c1.382-.063 2.326-.283 3.152-.604a6.363 6.363 0 0 0 2.3-1.498 6.363 6.363 0 0 0 1.498-2.3c.321-.826.541-1.77.604-3.152.063-1.385.078-1.827.078-5.35s-.015-3.965-.078-5.35c-.063-1.382-.283-2.326-.604-3.152a6.363 6.363 0 0 0-1.498-2.3 6.363 6.363 0 0 0-2.3-1.498c-.826-.321-1.77-.541-3.152-.604-1.385-.063-1.827-.078-5.35-.078zm0 2.338c3.464 0 3.875.013 5.243.075 1.265.058 1.952.27 2.41.447.605.235 1.037.516 1.491.97.454.454.735.886.97 1.491.177.458.389 1.145.447 2.41.062 1.368.075 1.779.075 5.243s-.013 3.875-.075 5.243c-.058 1.265-.27 1.952-.447 2.41-.235.605-.516 1.037-.97 1.491-.454.454-.886.735-1.491.97-.458.177-1.145.389-2.41.447-1.368.062-1.779.075-5.243.075s-3.875-.013-5.243-.075c-1.265-.058-1.952-.27-2.41-.447-.605-.235-1.037-.516-1.491-.97-.454-.454-.735-.886-.97-1.491-.177-.458-.389-1.145-.447-2.41-.062-1.368-.075-1.779-.075-5.243s.013-3.875.075-5.243c.058-1.265.27-1.952.447-2.41.235-.605.516-1.037.97-1.491.454-.454.886-.735 1.491-.97.458-.177 1.145-.389 2.41-.447 1.368-.062 1.779-.075 5.243-.075z" />
      <path d="M16 19.778a3.778 3.778 0 1 1 0-7.556 3.778 3.778 0 0 1 0 7.556zm0-9.6a5.822 5.822 0 1 0 0 11.644 5.822 5.822 0 0 0 0-11.644zM24.538 9.922a1.36 1.36 0 1 1-2.72 0 1.36 1.36 0 0 1 2.72 0z" />
    </svg>
  )
}
...
export default function MainLayout({ children }) {
  let hosts = ['Evan Hannan', 'Braxton Nohr']
  ...
  return (
    <AudioProvider>
      ...
      <footer className="border-t border-slate-200 bg-slate-50 py-10 pb-40 sm:py-16 sm:pb-4 lg:hidden">
